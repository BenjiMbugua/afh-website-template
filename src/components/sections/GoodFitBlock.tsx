        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div className="bg-green-50 border border-green-200 rounded-2xl p-6 sm:p-8">
            <div className="flex items-center gap-2 mb-5">
              ...
              <h3 className="font-bold text-navy text-lg">This home is a good fit if…</h3>
            </div>
          ...
          <div className="flex flex-col gap-6">
            <div className="bg-gray-50 border border-gray-200 rounded-2xl p-6 sm:p-8">
              ...
              <p className="text-xs text-neutral/60 mt-4">
                Not sure? Call us anyway — we are happy to help you find the right option even if that is not us.
              </p>
            </div>

            <div className="bg-navy rounded-2xl p-6 text-white flex flex-col gap-4">
